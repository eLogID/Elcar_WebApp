                ...
                <li class="active top10">
                    ...
                    <form id="frm" class="frm form-horizontal">
                        ...
                        <h5 style="font-size:18px;">
                            <b><?php echo Driver::t("General Setting")?></b>
                        </h5>
                        ...
                        <hr/>
                        <h5 style="font-size:18px;">
                            <b><?php echo Driver::t("App Settings")?></b>
                        </h5>

                        <div class="form-group">
                            <label class="col-sm-2 control-label"><?php echo Driver::t("Enabled Note")?></label>
                            <div class="col-sm-6">
                                <?php
                        ...
                        <hr/>
                        <h5 style="font-size:18px;">
                            <b><?php echo Driver::t("Map Settings")?></b>
                        </h5>
