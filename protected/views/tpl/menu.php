...
$menu =  array(
    ...
    'items'=>array(
        ...
        array('visible'=>true,'label'=>'<i class="ion-eye"></i>&nbsp; '.t("Views"),
            'url'=>array('/app/viewers'),'linkOptions'=>array()),
        ...
        array('visible'=>true,'label'=>'<i class="ion-map"></i>&nbsp; '.t("Agent Track"),
            'url'=>array('/app/tracks'),'linkOptions'=>array()),
